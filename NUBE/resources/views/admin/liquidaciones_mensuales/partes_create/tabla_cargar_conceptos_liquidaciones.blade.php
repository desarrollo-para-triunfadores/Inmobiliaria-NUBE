                        ...
                        <tr>
                            ...
                            <td>
                                <div class="input-group">
                                    ...
                                    <input type="text" class="form-control mascara_periodo" data-inputmask="'alias': 'dd/mm/yyyy'" data-mask="" onkeyup="carga_lineas({{$servicio_contrato->id}},'periodo', this.value)">
                                </div>
                            </td>
                            <td>
                                <div class="input-group">
