                                                ...
                                                <li class="item">
                                                    <div class="product-img">
                                                        <span class="info-box-icon-modificado">                                                                    
                                                            @if ($concepto->servicio_contrato->servicio->servicio_compartido)
                                                    ...
                                                    <div class="product-info">
                                                        <a href="javascript:void(0)" class="product-title">{{$concepto->servicio_contrato->servicio->nombre}}
                                                            <span class="label label-warning pull-right">${{$concepto->monto}}</span>
                                                        </a>
                                                        <span class="product-description">{{$concepto->servicio_contrato->servicio->descripcion}}</span>
                                                    </div>
                                                </li>
                                            @endforeach                                                            
                                        </ul>
                            ...
                            <div class="col-md-6">                                                               
                                ...
                                <form action="/admin/cobros/{{$liquidacion->id}}" method="POST" accept-charset="UTF-8">
                                    ...
                                    <div class="input-group pull-right input-group-sm col-xs-8">
                                        ...
                                        <input id="abono" name="abono" type="number" step="any" max="999999999" min="{{$liquidacion->total + $liquidacion->calcular_mora() - $saldo_cuenta}}" placeholder="ingrese aquí el monto que abonará el cliente" class="form-control" onchange="calcular_cambio()" onkeyup="calcular_cambio()" required>
