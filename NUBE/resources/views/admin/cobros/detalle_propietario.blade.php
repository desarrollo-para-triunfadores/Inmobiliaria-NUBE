        ...
        <div class="col-md-12">
            <div class="box box-solid collapsed-box">
                ...
                <div class="col-md-6 pull-right">                               
                    <br>                            
                    <h2 class="page-header pull-right"><b>Total:</b> ${{$liquidacion->comision_a_propietario}}</h2>                                
                    <br><br><br><br>                            
                    <form action="/admin/cobros/{{$liquidacion->id}}" method="POST" accept-charset="UTF-8">
                        <input name="_method" type="hidden" value="PUT">
                        <input type="hidden" name="_token" value="{{ csrf_token() }}"> 
                        <input type="hidden" id="total" value="{{$liquidacion->comision_a_propietario}}">                           
                        <input type="hidden" name="cobro_propietario" value="true">
                        <div class="input-group pull-right input-group-sm col-xs-8">
                            <span class="input-group-addon">$</span>    
                            <input id="abonado" name="abonado" type="number" step="any" max="999999999" min="{{$liquidacion->comision_a_propietario}}" placeholder="ingrese aquí el monto que abonará el cliente" class="form-control" onchange="calcular_cambio()" onkeyup="calcular_cambio()" required>
