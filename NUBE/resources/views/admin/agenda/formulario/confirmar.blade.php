    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h4 class="modal-title">Eliminar evento/visita</h4>
            </div>
            ...
            <div class="modal-footer">
                ...
                <button type="button" class="btn btn-outline" onclick="$('#boton_submit_borrar').click()">eliminar evento/visita</button>
            </div>
        </div>
    </div>
</div>
