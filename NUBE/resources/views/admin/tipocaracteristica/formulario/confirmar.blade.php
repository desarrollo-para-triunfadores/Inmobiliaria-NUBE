    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h4 class="modal-title">Eliminar tipo de característica</h4>
            </div>
            ...
            <div class="modal-footer">
                ...
                <button type="button" class="btn btn-outline" onclick="$('#boton_submit_borrar').click()">eliminar tipo de característica</button>
            </div>
        </div>
    </div>
</div>
