    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h4 class="modal-title">Eliminar característica</h4>
            </div>
            ...
            <div class="modal-footer">
                ...
                <button type="button" class="btn btn-outline" onclick="$('#boton_submit_borrar').click()">eliminar característica</button>
            </div>
        </div>
    </div>
</div>
