    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <form id="form-update" action="" method="POST" accept-charset="UTF-8" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                        ...
                        <select style="width: 100%" name="tipo_id" id="tipo_id" class="select2 form-control form-control-sm">
            ...
            <div class="modal-footer">
                ...
                <button type="button" class="btn  btn-warning" onclick="$('#boton_submit_update').click()">actualizar tipo de característica</button>
            </div>
        </div>
    </div>
</div>
