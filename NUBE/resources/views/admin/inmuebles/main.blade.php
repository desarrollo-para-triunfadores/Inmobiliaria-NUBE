						...
						<table id="example" class="display datatable responsive" cellspacing="0" width="100%">
							...
							<tbody>
								...
								<tr>
									...
									<td class="text-center"><a href="{{route('propietarios.show', $inmueble->propietario->id)}}">{{$inmueble->propietario->persona->nombre}} {{$inmueble->propietario->persona->apellido}}</a></td>
