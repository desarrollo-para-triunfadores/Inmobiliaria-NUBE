...
<div class="form-group">
    ...
    <video id="video_create" width="275" height="275" autoplay="true" class="hide"></video>
    <canvas id="canvas_create" name="imagen2" type="file" width="1280" height="720" class="hide"></canvas>  
