    ...
    <div class="modal-dialog" style="width: 80%">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h4 class="modal-title">Actualizar propietario</h4>
            </div>
            <div class="modal-body">
                ...
                <form id="form-update" action="" method="POST" accept-charset="UTF-8" enctype="multipart/form-data">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-4">
                            @include('admin.propietarios.formulario.imagen_update')
                        </div> 
                    </div>
            ...
            <div class="modal-footer">
                ...
                <button type="button" class="btn  btn-warning" onclick="mandar('update');">actualizar propietario</button>
            </div>
        </div>
    </div>
</div>
