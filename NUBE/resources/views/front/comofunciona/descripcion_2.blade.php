        ...
        <div class="row text-left">
            ...
            <div class="col-xs-12 col-sm-6 col-md-6 wow fadeInRightBig">
                ...
                <div class="bloque-descripcion">
                    <div class="item-descripcion-info">
                        <ul class="checklist">
                            <li>El seguro de caución es un contrato mediante el cual el aseurador se obliga a indemnizar al asegurado  por posibles prejuicios en caso de que el inquilino incumpla oblicaciones, legales o contractuales.</li>
                        </ul>
                    </div>
                </div>
            </div>
    ...
    <div class="container">
        ...
        <div class="row">
            ...
            <div class="col-sm-6 pull-left wow fadeInRightBig">
                <img class="img-responsive " src="{{asset('imagenes/comofunciona/Seguros.jpg')}}" alt="">
            </div>
            ...
            <div class="col-sm-6 wow fadeInLeftBig"  data-animation-delay="200">
                ...
                <div class="sub-title lead3">
                    ...
                    <li>Análisis de solvencia económica: Reunion y documentacion y verificación de candidatos</li>
                    <li>Negociación: Visitas al inmueble y presentacion de solicitudes de alquiler</li>
