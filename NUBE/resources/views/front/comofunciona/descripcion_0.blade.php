<section id="section-iconos" style="padding-top: 0px; padding-bottom: 0px">
    <div class="block fondo-traslucido">
        ...
        <div class="row contribution-columns">
            <div class="col-xs-6 contribution-propietario">
                <div class="contribute-propietario">
                    <i class="fa fa-4x fa-home color-banner"></i>
                    <h1 class="color-banner sombra size-h1-contribution" lang="es" style="font-weight: 400">¿Querés alquilar tu propiedad?</h1>
                    <h4 class="sombra" lang="es">Saber más</h4>
                </div>
                <div class="hidden-content">
                    ...
                    <div class="row">
                        <div class="col-hidden col-md-4">
                            ...
                            <p class="espaciado">Firmás el el contrato de alquiler y pagás al corredor el 2% del valor del contrato.</p>
                        </div>
                        <div class="col-hidden col-md-4">
            ...
            <div class="col-xs-6 contribution-inquilino">
                <div class="contribute-inquilino">
                    <i class="fa fa-4x fa-building-o color-banner"></i>
                    <h1 class="color-banner sombra size-h1-contribution" lang="es" style="font-weight: 400">¿Estás buscando mudarte?</h1>
                    <h4 class="sombra" lang="es">Saber más</h4>
                </div>
                <div class="hidden-content">
                    <div class="row">
