...
<div id="proyectos_carusel" class="carousel slide" data-ride="carousel" data-interval="7000">
    ...
    <div class="carousel-inner">
        <div class="item active">
            <img src="{{ asset('imagenes/proyectos/INube_1495497204.jpg') }}" alt="Chania">
        ...
        <div class="item">
            <img src="{{ asset('imagenes/proyectos/'.\App\ImagenInmueble::where('proyecto_id',$proyecto->id)->where('seccion_imagen','portada')->first()->nombre) }}" alt="">
            <div class="carousel-caption">
